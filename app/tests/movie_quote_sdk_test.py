...
def test_get_movie_quotes(requests_mock):
    ...
    quotes = MovieQuoteSDK(API_KEY).get_movie_quotes('5cd96e05de30eff6ebcce9cb')
    assert len(quotes) == 4